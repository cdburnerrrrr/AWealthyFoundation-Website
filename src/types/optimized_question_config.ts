...
// INVESTING
  ...
  },
  {
    ...
    tags: {
      modes: ['detailed'],
      priority: 'conditional',
      // Show this in the Comprehensive investing block unless the user explicitly said they are not investing.
      // This keeps the grouped 401(k) / Roth / brokerage / HSA card from disappearing in continue mode.
  ...
  },
  {
    ...
    tags: { modes: ['detailed'], priority: 'conditional', askIf: () => false },},
    {
      ...
      question: 'Do you have any crypto, individual stocks, or other assets we have not already covered?',
      type: 'multiple',
      section: 'investing',
      required: false,
      helperText:
    ...
    },
    {
      ...
      required: false,
      placeholder: 'e.g. 5000',
      helperText: 'Legacy field. Current other assets are captured in the grouped additional assets card.',
      conditions: [{ operator: 'custom', fn: () => false }],
      tags: { modes: ['detailed'], priority: 'conditional', askIf: () => false },
    },
  ...
  tags: {
    ...
    askIf: (a) =>
      ...
      (
        ...
        Boolean(a.otherAssets) || Boolean(a.cryptoAssetValue) || Boolean(a.individualStockValue)
      ),
  },
},
