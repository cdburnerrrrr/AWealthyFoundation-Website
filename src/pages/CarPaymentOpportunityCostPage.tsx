...
import CarPaymentOpportunityCostTool from '../components/CarPaymentOpportunityCostTool';

export default function CarPaymentOpportunityCostPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#d8ecf8] text-[#0f2a44]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden opacity-[0.2]">
        <div className="absolute left-[10%] top-24 h-64 w-64 rounded-full border border-[#0f3a5a]/28" />
        <div className="absolute bottom-20 right-[12%] h-48 w-48 rounded-full border border-[#0f3a5a]/24" />
        <div className="absolute left-[25%] top-16 w-72 border-t border-dashed border-[#0f3a5a]/26" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 max-w-3xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-[#325672]">
            See what your payment is really costing today — and what it could become if redirected toward margin, investing, or freedom.
          </p>
        </div>
        ...
        <div className="relative rounded-[32px] border border-[#0f3a5a]/14 bg-white/32 p-2.5 shadow-[0_18px_52px_rgba(15,58,90,0.10)] backdrop-blur-[2px]">
          ...
          <div className="relative rounded-[26px] bg-white/54 p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.45)] ring-1 ring-[#0f3a5a]/8 sm:p-3">
            <CarPaymentOpportunityCostTool />
          </div>
        </div>
      </div>
    </div>
