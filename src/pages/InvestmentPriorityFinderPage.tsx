...
import InvestmentPriorityFinderTool from '../components/InvestmentPriorityFinderTool';

export default function InvestmentPriorityFinderPage() {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 max-w-3xl">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-[#0f2a44] sm:text-5xl">
            Investment Priority Finder
          </h1>
          <p className="mt-3 max-w-2xl text-base leading-7 text-[#325672]">
            Decide where the next investment dollar should probably go before adding more complexity.
          </p>
        </div>
