...
import GrowthPathBuilderTool from '../components/GrowthPathBuilderTool';

export default function GrowthPathBuilderPage() {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 max-w-3xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-[#325672]">
            See how consistent investing could grow over time, or work backward from a future goal.
          </p>
        </div>
