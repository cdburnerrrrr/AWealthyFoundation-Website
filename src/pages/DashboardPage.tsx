...
export default function DashboardPage({ onLogout }: DashboardPageProps) {
  ...
  const isFirstTimeUser = !showAssessment;
    ...
    <div className="min-h-screen bg-[#f6f9fc] flex flex-col">
      ...
      <main ref={printRef} className="max-w-7xl mx-auto px-4 py-8 flex-1">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
          <h1 className="text-2xl sm:text-4xl font-bold text-navy-900 mb-2">
  {isFirstTimeUser
  ...
  <div className="bg-white border border-[#d7e3f0] rounded-3xl p-12 text-center shadow-sm">
    ...
    <p className="text-gray-600 mb-8 max-w-xl mx-auto">
      Choose how you want to begin. Start with a quick snapshot or take the full assessment for deeper insights and a personalized plan.
    </p>

    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      <button
        onClick={() => navigate('/assessment/snapshot')}
        className="px-6 py-4 border border-[#d7e3f0] text-navy-900 font-semibold rounded-xl hover:bg-[#f8fbff] transition-colors"
      >
        Free Snapshot
      </button>
      ...
      <button
        ...
        className="px-6 py-4 bg-copper-600 text-white font-semibold rounded-xl hover:bg-copper-700 transition-colors"
      >
        Full Assessment
      </button>
    </div>
