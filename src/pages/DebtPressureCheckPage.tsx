...
import DebtPressureCheckTool from '../components/DebtPressureCheckTool';

export default function DebtPressureCheckPage() {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-[#325672]">
            This tool shows how much your required debt payments are squeezing your month once
            the rest of your core obligations are already spoken for.
          </p>
        </div>
